    ...
    private void detectLinkContentType(String url) {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                // نقل التحديث إلى الـ Main Thread لتفادي الـ Build & Run Crashes
                ...
                if (response.isSuccessful()) {
                    ...
                    runOnUiThread(() -> {
                        if (contentType != null) {
                            ...
                            tvStatus.setText("تم العثور على رابط مباشر.");
                        }
                        btnDownload.setVisibility(View.VISIBLE);
                    });
                } else {
                    runOnUiThread(() -> tvStatus.setText("الرابط لا يستجيب بشكل صحيح."));
                }
                response.close();
            }
        });
        ...
        PRDownloader.download(fileUrl, downloadPath, fileName)
                ...
                .start(new com.downloader.OnDownloadListener() {
                    ...
                    public void onDownloadComplete() {
                        runOnUiThread(() -> {
                            tvStatus.setText("تم التحميل بنجاح: " + fileName);
                    ...
                    public void onError(com.downloader.Error error) {
                        runOnUiThread(() -> tvStatus.setText("حدث خطأ أثناء تحميل الملف."));
                    }
                });
    }
}
